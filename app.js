// Deutsche Bank AI Presentation - Slide Navigation
...
class PresentationUtils {
    static getSlideNotes(slideIndex) {
        ...
        const notes = {
            ...
            1: "The data shows AI adoption is accelerating across investment banking. Deutsche Bank has strong foundations to build on.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Deutsche Bank AI Presentation loaded successfully');
